...
for BATCH_SIZE in [1, 2, 4]:
    for cv_fold in range(5):
        for window in [10, 20, 40]:
            nn_dir = (
                f"/project/bowmanlab/ameller/gvp/net_8-50_1-32_16-100_"
            ...
            if not os.path.exists(os.path.join(nn_dir, "test_auc.npy")):
                ...
                os.system(
                    f'sed -i "s/python train_pockets.py.*/python train_pockets.py {BATCH_SIZE} {cv_fold} {window}/g" train-submit-amd.sh;'
                )
